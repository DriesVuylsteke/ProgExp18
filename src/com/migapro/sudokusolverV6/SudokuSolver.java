package com.migapro.sudokusolverV6;
 ...
 * 
 * edits:		1. 	Making the color a member of the class. (58 + 59)
 * 				2.	Changing the color creation into a member call. (363 + 520 + 522 + 528)
 * 
 * @author Daniel
 * @version 2.0
 *
...
public class SudokuSolver extends JFrame implements ActionListener, ISolver{
	...
	private final Color markedColor = new Color(150, 150, 150);
	private final Color focusColor = new Color(255, 227, 209);
		...
		public SudokuCell(final int row, final int col) {
			...
			addFocusListener(new FocusListener(){
				...
				public void focusGained(FocusEvent arg0) {
					...
					for (int i = 0; i < 9; i++) {
						// Horizontal
						sudokuCells[i][col].setBackground(focusColor);
						// Vertical
						sudokuCells[row][i].setBackground(focusColor);
					}

					// 3x3 box
					for (int i = startRow; i < startRow + 3; i++)
						for (int j = startCol; j < startCol + 3; j++)
							sudokuCells[i][j].setBackground(focusColor);
				}
				...
				public void focusLost(FocusEvent arg0) {
					...
					for (int i = 0; i < 9; i++) {
						// Horizontal
						sudokuCells[i][col].setBackground(backgroundColor);
						// Vertical
						sudokuCells[row][i].setBackground(backgroundColor);
					}
					
					// 3x3 box
					for (int i = startRow; i < startRow + 3; i++)
						for (int j = startCol; j < startCol + 3; j++)
							sudokuCells[i][j].setBackground(backgroundColor);
				}
